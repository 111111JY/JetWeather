...
import com.example.aiiage.jetweather.util.*;
...
public class AutoUpdateService6 extends Service {
    public AutoUpdateService6() {
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (isUpdateTime == true){
            ...
            Intent i = new Intent(this, AutoUpdateService6.class);
    ...
    private void updateWeather() {
        ...
        if (weatherString != null) {
            Weather weather = Utility.handleWeather6Response(weatherString);
            ...
            HttpUtil.sendOkHttpRequest(weatherUrl, new Callback() {
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    ...
                    if (weather != null && "ok".equals(weather.status)) {
                        SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(AutoUpdateService6.this)
                                .edit();
